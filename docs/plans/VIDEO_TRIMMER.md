...
| — | **STOP — manual smoke session #2 (re-verify preview after the fix)** | — |
| 10 | `test(video-trimmer): Playwright happy-path e2e` | pending |
| 11 | `chore(video-trimmer): ship — DECISIONS entry, backlog, drop working doc` | pending |
