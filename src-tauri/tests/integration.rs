...
//!
//! These exercise `multitool_lib`'s public surface from outside the crate
...
use multitool_lib::{ipc::JobId, AppError};
...
fn job_registry_round_trips_through_public_api() {
    let registry = multitool_lib::ipc::JobRegistry::default();
