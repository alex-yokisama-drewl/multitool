...
const e2eAliases: Record<string, string> = e2e
  ? {
      ...
      "@/lib/tools/audioFormatConverter": path.resolve(
        import.meta.dirname,
        "./tests/e2e/mocks/audioFormatConverter.ts",
      ),
      "@/lib/tools/audioTrimmer": path.resolve(
        import.meta.dirname,
        "./tests/e2e/mocks/audioTrimmer.ts",
      ),
      "@/lib/tools/videoFormatConverter": path.resolve(
        import.meta.dirname,
      ...
      "@/lib/imageFormats": path.resolve(
        import.meta.dirname,
        "./tests/e2e/mocks/imageFormats.ts",
      ),
